 ...
 * context.
 */
enum v7_err v7_exec_with(struct v7 *, const char *js_code, v7_val_t this_obj, v7_val_t *result);
 ...
 */
enum v7_err v7_compile(const char *js_code, int generate_binary_output, FILE *fp);
...
v7_val_t v7_create_constructor(struct v7 *v7, v7_val_t proto, v7_cfunction_t f, int num_args);
 ...
 */
v7_val_t v7_create_regexp(struct v7 *, const char *regex, size_t regex_len, const char *flags, size_t flags_len);
 ...
 */
enum v7_err v7_apply(struct v7 *, v7_val_t *result, v7_val_t func, v7_val_t this_obj, v7_val_t args);
 ...
 */
int v7_set(struct v7 *v7, v7_val_t obj, const char *name, size_t name_len, unsigned int attrs, v7_val_t val);
...
int v7_main(int argc, char *argv[], void (*init_func)(struct v7 *), void (*fini_func)(struct v7 *));


double v7_get_double(struct v7 *v7, v7_val_t v);
int v7_get_int(struct v7 *v7, v7_val_t v);
